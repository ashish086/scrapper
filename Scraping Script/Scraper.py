...
class Driver: 
    def __init__(self, driver_path: str = "C:\\Users\\SUBHAM\\OneDrive\\Desktop\\FoodGrab_Scrapping-main\\driver\\chromedriver.exe") -> None:
    ...
    def setup(self): # Setup the browser
        ...
        HEADERS = ({'user_agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36' , 'Accept-Language': 'en-US, en;q=0.5'})
 # Set the user agent
        chrome_opts.add_argument(f'user_agent={user_agent}') # Add the user agent
...
class Scraper:  
    ...
    def load_more(self):  # clicking load more button to load more restaurants in the list
        ...
        condition = EC.presence_of_element_located((By.XPATH, '//*[@id="page-content"]')) # find element in Document Object Model (DOM)
...
if __name__ == "__main__":
    driver_path = "C:\\Users\\SUBHAM\\OneDrive\\Desktop\\FoodGrab_Scrapping-main\\driver\\chromedriver.exe"  # path to the chromedriver
